    ...
    return (
      <section className="mt-2">
        <div className="flex flex-col gap-1">
          <span className="text-xs font-label uppercase tracking-widest text-secondary/70">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <div className="flex justify-between items-center p-4 rounded-xl bg-surface-container-low border border-outline-variant/10 transition-all hover:bg-surface-container duration-300">
              <div>
                <p className="text-[10px] font-label text-outline uppercase tracking-wider">Wartość Realna (Po Inflacji)</p>
                <AnimatedCounter 
                  value={finalReal}
                  className="text-xl font-headline font-bold text-tertiary-fixed-dim" 
                />
              </div>
              <div className="text-right">
                <p className="text-[10px] font-label text-outline uppercase tracking-wider">Zysk Netto</p>
                <AnimatedCounter 
                  value={netProfit}
                  prefix="+"
            ...
            <div className="flex justify-between items-center p-4 rounded-xl bg-linear-to-r from-[#b721ff]/20 to-transparent border border-[#b721ff]/30 transition-all hover:shadow-[0_0_20px_rgba(183,33,255,0.15)] duration-300">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[#b721ff]" style={{ fontVariationSettings: "'FILL' 1" }}>gpp_good</span>
                <p className="text-xs font-label text-[#e4b5ff] uppercase tracking-wider font-bold">Zaoszczędzony podatek Belki (19%)</p>
              </div>
              <AnimatedCounter 
                value={taxShield}
                prefix="+"
            ...
            <div className="p-4 rounded-xl bg-surface-container-lowest border border-outline-variant/10 space-y-3">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-outline/60 text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance_wallet</span>
              ...
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-[9px] font-label text-outline/60 uppercase tracking-wider">Łączny Wkład Własny</p>
                  <AnimatedCounter 
                ...
                <div className="text-right">
                  <p className="text-[9px] font-label text-outline/60 uppercase tracking-wider">Siła Nabywcza Wkładu</p>
                  <AnimatedCounter 
                    value={investedRealAtRetirement}
                    className="text-lg font-headline font-bold text-tertiary-fixed-dim" 
                  />
                </div>
              </div>
              <div className="flex items-center gap-2 pt-1 border-t border-outline-variant/10">
                <span className="material-symbols-outlined text-secondary text-sm">trending_up</span>
                <p className="text-[10px] font-body text-outline/80">
                  Wpłacasz <span className="font-bold text-white">{investedAtRetirement > 0 ? new Intl.NumberFormat('pl-PL', { style: 'currency', currency: 'PLN', maximumFractionDigits: 0 }).format(investedAtRetirement) : '0 zł'}</span>, 
    ...
    <section className="mt-2">
      <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <div className="flex justify-between items-center p-4 rounded-xl bg-surface-container-low border border-outline-variant/10 transition-all hover:bg-surface-container duration-300">
            <div>
              <p className="text-[10px] font-label text-outline uppercase tracking-wider">Kapitał Końcowy (Spadek)</p>
              <AnimatedCounter 
            ...
            <div className="text-right">
              <p className="text-[10px] font-label text-outline uppercase tracking-wider">Łącznie Wypłacone</p>
              <AnimatedCounter 
          ...
          <div className="flex justify-between items-center p-4 rounded-xl bg-surface-container-low border border-outline-variant/10 transition-all hover:bg-surface-container duration-300">
            <div>
              <p className="text-[10px] font-label text-outline uppercase tracking-wider">Wypłata Miesięczna (Dziś)</p>
              <AnimatedCounter 
            ...
            <div className="text-right">
              <p className="text-[10px] font-label text-outline uppercase tracking-wider">Wypłata Roczna</p>
              <AnimatedCounter 
      ...
      {/* Alert bankructwa */}
      {bankruptAge != null && (
        <div className="mt-4 p-4 rounded-xl bg-error/10 border border-error/30 flex items-center gap-3">
      ...
      {bankruptAge == null && store.withdrawalYears > 0 && (
        <div className="mt-4 p-4 rounded-xl bg-secondary/10 border border-secondary/30 flex items-center gap-3">
