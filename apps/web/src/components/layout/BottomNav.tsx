export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center h-20 px-4 pb-safe bg-surface-container-low/90 backdrop-blur-2xl border-t border-outline-variant/10 shadow-[0_-10px_30px_rgba(0,0,0,0.5)] z-50 rounded-t-xl">
      <a className="flex flex-col items-center justify-center text-[#c0c1ff] bg-primary-container/10 rounded-xl px-4 py-1 active:translate-y-0.5 duration-150 transition-colors" href="#">
